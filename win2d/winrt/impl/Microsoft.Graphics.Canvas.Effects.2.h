...
template <> struct is_struct<Microsoft::Graphics::Canvas::Effects::ColorManagementSimpleProfile>
{
    static constexpr bool value{ true };
};

template <> struct is_struct<Microsoft::Graphics::Canvas::Effects::Matrix5x4>
{
    static constexpr bool value{ true };
};
